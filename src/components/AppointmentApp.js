    ...
    return (
      <div style={{ margin: "12px 0" }}>
        <RaisedButton
          ...
          style={{marginRight: 12, backgroundColor: "#b8864a"}}
        />
        {step > 0 && (
          <FlatButton
            label="Back"
              ...
              <Step>
                ...
                <StepContent>
                    ...
                    <section>
                      ...
                      />
                      <RaisedButton
                        style={{ display: "block",  backgroundColor: "#b8864a"}}
                        label={
                          contactFormFilled
                            ? "Schedule"
                        ...
                        style={{ marginTop: 20, maxWidth: 100, backgroundColor: "#b8864a"}}
                      />
                    </section>
